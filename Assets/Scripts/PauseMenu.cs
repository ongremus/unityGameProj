...
public class PauseMenu : MonoBehaviour
{
	...
	public Color statColor = Color.black;
 
	public string[] credits= {
	    "Little Butterfly Production",
	...
	void ShowBackButton() {
	    if (GUI.Button(new Rect(20, Screen.height - 50, 80, 50),"Back")) {
	        currentPage = Page.Main;
	    }
	}
	...
	void ShowStatNums() {
	    GUILayout.BeginArea( new Rect(Screen.width - 100, 10, 300, 500));
	    if (showfps) {
	...
	void MainPauseMenu() {
	    BeginPage(400,400);
	    if (GUI.Button(new Rect(Screen.width,Screen.height,100,100),"Continue")) {
	        UnPauseGame();
